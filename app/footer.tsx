      ...
      <Dialog>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              This project is made and maintained by{" "}
              <Link
          ...
          <div className='max-h-[60vh] overflow-y-scroll no-scrollbar px-2 my-2 space-y-2'>
            <p>
            ...
            <p className='text-sm'>
              Disclaimer: The project creator is not liable for any harmful
              content shared via links generated by this application.
            </p>
          </div>
          <DialogFooter>
            <DialogTrigger asChild>
